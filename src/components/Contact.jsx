    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-gray-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            Just a contact away! Reach out, let's discuss your project and make
            it happen.
          </p>
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-inset ring-3 ring-gray-50/5 rounded-lg transition-[background-color] hover:bg-gray-50 hover:text-gray-950 active:bg-gray-50/80 reveal-up"
              >
                {icon}
              </a>
            ))}
        ...
        <form
          action="https://getform.io/f/adrgyona"
          method="POST"
